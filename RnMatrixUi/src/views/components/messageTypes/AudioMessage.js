...
import { Text, TouchableHighlight, View, StyleSheet, TouchableOpacity, Image } from 'react-native';
                ...
                <View style={[styles.audioPreview, isMe && styles.audioPreviewMy]}>
                  ...
                  <View style={styles.audioTrackProgress}>
                    ...
                    <View style={styles.audioTimeContainer}>
                      <Text style={[styles.audioTimeText, isMe && styles.audioTimeTextMy]}>{playtime}</Text>
                    </View>
                  </View>
                </View>
